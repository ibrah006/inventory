                                      ...
                                      child: IconButton(
                                          style: ButtonStyle(
                                              padding: WidgetStatePropertyAll(
                                                  EdgeInsets.zero)),
                                          onPressed: () {
                                            issueDateMenuController.showFlyout(
...
//       content: Column(
//         children: [
//           PurchaseInvoiceTopSection(),
//           SizedBox(height: 30),
//           // Table
//           GroupTable(group: Group(id: "invoice-table", name: "Invoice table"))
//         ],
//       ),
//     );
//   }
...
// class PurchaseInvoiceTopSection extends StatefulWidget {
//   @override
//   State<PurchaseInvoiceTopSection> createState() =>
//       _PurchaseInvoiceTopSectionState();
// }

// class _PurchaseInvoiceTopSectionState extends State<PurchaseInvoiceTopSection> {
//   String vendor = "";

//   @override
//   Widget build(BuildContext context) {
//     final stock = Provider.of<StockProvider>(context, listen: false).getStock();
...
//                             if (focused) {
//                               debugPrint(
//                                   'Focused ${stockItem.id} ${stockItem.desc}');
//                             }
//                           });
//                     }).toList(),
//                     onSelected: (item) {
...
//                     width: 200,
//                     child: InfoLabel(
//                       label: "Order/Quote No.",
//                       child: ComboBox<String>(
//                         isExpanded: true,
//                         items: [
//                           ComboBoxItem(child: Text("Quote 1"), value: "1"),
//                           ComboBoxItem(child: Text("Quote 2"), value: "2"),
//                         ],
//                         onChanged: (value) {},
//                       ),
//                     ),
...
//           // Items Stored Dropdown
//           // SizedBox(
//           //   width: 200,
//           //   child: InfoLabel(
//           //     label: "Items Stored At",
//           //     child: ComboBox<String>(
//           //       isExpanded: true,
//           //       items: [
//           //         ComboBoxItem(child: Text("Warehouse 1"), value: "1"),
//           //         ComboBoxItem(child: Text("Warehouse 2"), value: "2"),
//           //       ],
//           //       onChanged: (value) {},
//           //     ),
//           //   ),
...
//           //       isExpanded: true,
//           //       items: [
//           //         ComboBoxItem(child: Text("Site A"), value: "A"),
//           //         ComboBoxItem(child: Text("Site B"), value: "B"),
//           //       ],
//           //       onChanged: (value) {},
//           //     ),
//           //   ),
